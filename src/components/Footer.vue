          ...
          <div class="identity">
            <div class="wrap-logo-lib">
              ...
              >
                ...
                <img
                  src="@/assets/img/mitlib-wordmark.svg"
                  alt="MIT Libraries logo"
                />
              </a>
            </div>
            <div class="wrap-social">
              ...
              <a href="https://www.facebook.com/mitlib" title="Facebook">
                <svg
                  ...
                  width="2048"
                  height="2048"
                  viewBox="-640 -384 2048 2048"
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <g transform="scale(1 -1) translate(0 -1280)">
                    <path
                      d="M511 980h257l-30 -284h-227v-824h-341v824h-170v284h170v171q0 182 86 275.5t283 93.5h227v-284h-142q-39 0 -62.5 -6.5t-34 -23.5t-13.5 -34.5t-3 -49.5v-142z"
                      fill="black"
                    ></path>
                  </g>
                </svg>
                <span class="sr">Facebook</span> </a
              ><!-- End Facebook -->
            ...
            <div class="wrap-middle">
              <div class="wrap-sitemap">
                <nav
                  class="sitemap-libraries-abbrev"
                  aria-label="MIT Libraries site menu"
                >
                  <h2 class="sr">MIT Libraries navigation</h2>
                  <a class="item" href="https://libraries.mit.edu/search"
                    >Search</a
                  >
                  <a class="item" href="https://libraries.mit.edu/hours"
                    >Hours &amp; locations</a
                  >
                  <a class="item" href="https://libraries.mit.edu/borrow"
                    >Borrow &amp; request</a
                  >
                  <a
                    class="item"
                    href="https://libraries.mit.edu/research-support"
                    >Research support</a
                  >
                  <a class="item" href="https://libraries.mit.edu/about"
                    >About us</a
                  >
                </nav>
              </div>
              ...
              <div class="wrap-policies">
                <nav aria-label="MIT Libraries policy menu">
                  <span class="item"
                    ><a
                      href="https://libraries.mit.edu/privacy"
                      class="link-sub"
                      >Privacy</a
                    ></span
                  >
                  <span class="item"
                    ><a
                      href="https://libraries.mit.edu/permissions"
                      class="link-sub"
                      >Permissions</a
                    ></span
                  >
                  <span class="item"
                    ><a
                      href="https://libraries.mit.edu/accessibility"
                      class="link-sub"
                      >Accessibility</a
                    ></span
                  >
        ...
        <div class="footer-info-institute">
          <a class="link-logo-mit" href="https://www.mit.edu">
            ...
            <svg
              ...
              class="logo-mit"
            >
              <rect x="28.9" y="8.9" width="5.8" height="19.1" class="color" />
              <rect width="5.8" height="28" />
              <rect x="9.6" width="5.8" height="18.8" />
              <rect x="19.3" width="5.8" height="28" />
              <rect x="38.5" y="8.9" width="5.8" height="19.1" />
              <rect x="38.8" width="15.2" height="5.6" />
              <rect x="28.9" width="5.8" height="5.6" />
            </svg>
          </a>
          <div class="about-mit">
          ...
          <div class="license">
            ...
            <a
              href="https://libraries.mit.edu/research-support/notices/copyright-notify/"
              >Notify us about copyright concerns</a
            >.
          </div>
          <!-- end .footer-info-institute -->
        </div>
      </div>
    </div>
  </footer>
